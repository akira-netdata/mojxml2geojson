...
def MojXMLtoGeoJSON(mojObj: dict, exclude_flag):
    ...
    for key in IdHudeTable.keys():
        ...
        hude_property = setExistProperties(hude,
                                           ['@id', '地図番号', '縮尺分母', '地図種類', '地図分類', '地図作成年月日', '備付地図年月日', '大字コード', '丁目コード', '小字コード', '予備コード', '大字名', '丁目名', '小字名', '予備名', '地番', '精度区分', '座標値種別', '筆界未定構成筆'],
                                           ['筆ID', '地図番号', '縮尺分母', '地図種類', '地図分類', '地図作成年月日', '備付地図年月日', '大字コード', '丁目コード', '小字コード', '予備コード', '大字名', '丁目名', '小字名', '予備名', '地番', '精度区分', '座標値種別', '筆界未定構成筆'])
